            ...
            <div className="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Button className="relative overflow-hidden group bg-gradient-to-r from-[#4169a1] to-[#5f825a] hover:from-[#4169a1]/90 hover:to-[#5f825a]/90 text-white border-0 h-12 px-8">
                  <span className="relative z-10">Proponer un Desafío</span>
                  <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                </Button>
                <Button
                  variant="outline"
              ...
              <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm overflow-hidden group">
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2">Plataforma NexusAI</h3>
                      <p className="text-gray-400 mb-4">
                        Una plataforma inteligente de procesamiento de datos que utiliza aprendizaje automático para
                        analizar conjuntos de datos complejos y generar información procesable para clientes
                        empresariales.
                      </p>
              ...
              <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm overflow-hidden group">
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2">Quantum Workflow</h3>
                      <p className="text-gray-400 mb-4">
                        Un sistema revolucionario de automatización de flujos de trabajo que se adapta a las cambiantes
                        necesidades empresariales mediante modelado dinámico de procesos y optimización en tiempo real.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <span className="px-2 py-1 bg-[#5f825a]/20 text-[#5f825a]/90 text-xs rounded-full">
                          Automatización
              ...
              <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm overflow-hidden group">
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2">Suite de Seguridad Fusion</h3>
                      <p className="text-gray-400 mb-4">
                        Una plataforma avanzada de ciberseguridad que combina análisis de comportamiento, inteligencia
                        de amenazas y sistemas de respuesta automatizados para proteger infraestructuras críticas.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <span className="px-2 py-1 bg-[#b43c3c]/20 text-[#b43c3c]/90 text-xs rounded-full">
                          Ciberseguridad
                        ...
                        <span className="px-2 py-1 bg-gray-700 text-gray-300 text-xs rounded-full">Confianza Cero</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm overflow-hidden group">
                <div className="p-6 relative">
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2">Colaboración Synapse</h3>
                      <p className="text-gray-400 mb-4">
                        Una plataforma de colaboración de próxima generación que rompe los silos entre equipos con
                        comunicación contextual, intercambio de conocimientos y gestión de proyectos.
                      </p>
                      <div className="flex flex-wrap gap-2">
                        <span className="px-2 py-1 bg-[#d4b95e]/20 text-[#d4b95e]/90 text-xs rounded-full">
                ...
                <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm h-full">
                  <div className="p-6 h-full flex flex-col">
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-800 flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold">Alejandro Chen</h4>
                        <p className="text-sm text-gray-400">Fundador y Director de Innovación</p>
                      </div>
                    </div>
                  </div>
                </Card>
                  ...
                  <div className="p-6 h-full flex flex-col">
                    ...
                    <div className="space-y-6 flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="font-medium">Ingenieros</h4>
              ...
              <div className="p-8 md:p-12 relative">
                ...
                <div className="max-w-3xl mx-auto text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button className="relative overflow-hidden group bg-gradient-to-r from-[#4169a1] to-[#5f825a] hover:from-[#4169a1]/90 hover:to-[#5f825a]/90 text-white border-0 h-12 px-8">
                      <span className="relative z-10">Propón tu Desafío</span>
                      <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                    </Button>
                    <Button
                      variant="outline"
